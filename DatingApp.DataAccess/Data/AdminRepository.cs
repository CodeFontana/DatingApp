...
public class AdminRepository : IAdminRepository
{
    ...
    public AdminRepository(UserManager<AppUser> userManager, RoleManager<AppRole> roleManager)
    {
    ...
    public async Task<List<UserWithRolesReadModel>> GetUsersWithRolesAsync()
    {
        return await _userManager.Users
            ...
            .AsNoTracking()
            .Select(u => new UserWithRolesReadModel
            {
                Id = u.Id,
    ...
    public async Task EditRolesAsync(UserWithRolesReadModel userWithRoles)
    {
