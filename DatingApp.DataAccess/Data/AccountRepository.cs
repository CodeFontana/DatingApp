...
public class AccountRepository : IAccountRepository
{
    ...
    public async Task<AppUser> CreateAccountAsync(RegisterAccountData registerUser)
    {
    ...
    public async Task<AppUser> LoginAsync(LoginCredentials loginUser)
    {
    ...
    public async Task UpdateAccountAsync(AccountUpdateData updateAccount)
    {
